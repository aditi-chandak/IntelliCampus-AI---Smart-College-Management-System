<%-- 
    Document   : addStudent
    Created on : 28 Jan 2026, 10:30:57 pm
    Author     : HP
--%>
...
%>
<div class="container"> 
    <h1><i><u>Add-Student's Data...</i></u></h1>
  ...
  <td>
    <select name="section" required>
      ...
      <option value="C">C</option>
                ...
                <tr>
                     <td></td>
                    <td><strong><input type="submit" name="Login" /></strong></td>
                </tr>
                
                <tr>
                    <td></td>
                    <td><strong><input type="reset" name="Reset" /></strong></td>
                </tr>
            </table>
</div>
        </form>
