<%-- 
    ...
    Created on : 10 Mar 2026, 7:43:42 pm
    Author     : HP
--%>
...
String branch ="";
            ...
            String query = "SELECT u.student_id, u.student_name,u.student_password ,u.student_email, u.student_mobile, b.branch_name " +
        "FROM student u " +
        ...
        "WHERE u.student_name='" + username + "' ";
           ...
           name = rs.getString("student_name");
              ...
              mobile = rs.getString("student_mobile");
        ...
        %>
        <div class="container">
        <h1>Student's-Profile is as follows :-</h1>
